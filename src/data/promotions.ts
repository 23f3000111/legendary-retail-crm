...
export const seedPromotions: Promotion[] = [
  {
    ...
    mechanic: 'discount',
    detail: '15% off the Nyonya collection',
    from: '2026-08-29',
    to: '2026-09-01',
    skuIds: [],
  ...
  },
  {
    ...
    name: 'Wishes duo',
    mechanic: 'bundle',
    detail: 'Any two Wishes for RM 160',
    from: '2026-08-01',
    to: '2026-08-31',
    skuIds: [],
  ...
  },
  {
    ...
    name: 'Payday weekend',
    mechanic: 'discount',
    detail: '12% off the Spirit collection',
    from: '2026-08-25',
    to: '2026-08-28',
    skuIds: [],
    locationIds: ['klcc-isetan', 'parkson-pavilion', 'parkson-imago'],
    plannedBy: 'Lim Davy',
    recordedBy: 'Chloe Chock',
